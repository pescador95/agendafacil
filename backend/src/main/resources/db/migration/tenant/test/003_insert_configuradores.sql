...
VALUES
    (
        nextval(
            'test.configuradoragendamento_id_seq' :: regclass
        ),
        FALSE,
        FALSE,
        FALSE,
...
INSERT INTO
    test.CONFIGURADORAGENDAMENTOESPECIAL (
        ID,
        NOME,
        PROFISSIONALID,
        DATAINICIO,
...
VALUES
    (
        nextval(
            'test.configuradoragendamentoespecial_id_seq' :: regclass
        ),
...
VALUES
    (
        nextval(
            'test.configuradorausencia_id_seq' :: regclass
        ),
...
INSERT INTO
    test.CONFIGURADORAUSENCIAUSUARIO (CONFIGURADORAUSENCIAID, USUARIOID)
VALUES
    (1, 1);
...
VALUES
    (
        nextval(
            'test.configuradornotificacao_id_seq' :: regclass
        ),
        NOW(),
        1,
        '01:00',
