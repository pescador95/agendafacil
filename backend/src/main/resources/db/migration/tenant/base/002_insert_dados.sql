-- tipoagendamento
INSERT INTO
    base.TIPOAGENDAMENTO (ID, TIPOAGENDAMENTO)
VALUES
    (
        nextval('base.tipoagendamento_id_seq' :: regclass),
        'Fisioterapia'
    );
...
-- statusagendamento
INSERT INTO
    base.STATUSAGENDAMENTO (ID, STATUS)
VALUES
    (
        nextval('base.statusagendamento_id_seq' :: regclass),
        'Agendado'
    );
...
-- genero
INSERT INTO
    base.GENERO (ID, GENERO)
VALUES
    (
        nextval('base.genero_id_seq' :: regclass),
        'Masculino'
    );
...
VALUES
    (
        nextval('base.role_id_seq' :: regclass),
        'usuario',
        FALSE
    );
...
VALUES
    (
        nextval('base.endereco_id_seq' :: regclass),
        85485000,
        'Avenida Brasil',
        500,
...
VALUES
    (
        ...
        NULL,
        NULL,
        nextval('base.pessoa_id_seq' :: regclass),
        NULL,
        NULL,
        0,
        NULL,
...
VALUES
    (
        ...
        0,
        1,
        nextval('base.organizacao_id_seq' :: regclass),
        NULL,
        200,
        NULL,
        0,
...
VALUES
    (
        ...
        NULL,
        NULL,
        nextval('base.usuario_id_seq' :: regclass),
        1,
        1,
        NULL,
        NULL,
...
INSERT INTO
    base.USUARIOROLES (USUARIOID, ROLEID)
VALUES
    (1, 1);
...
INSERT INTO
    base.USUARIOORGANIZACAO (USUARIOID, ORGANIZACAOID)
VALUES
    (1, 1);
...
INSERT INTO
    base.TIPOAGENDAMENTOORGANIZACOES (
        TIPOAGENDAMENTOID,
        ORGANIZACAOID
    )
VALUES
