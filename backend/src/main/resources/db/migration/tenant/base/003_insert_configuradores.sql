...
VALUES
    (
        nextval(
            'base.configuradoragendamento_id_seq' :: regclass
        ),
        FALSE,
        FALSE,
        FALSE,
...
VALUES
    (
        nextval(
            'base.configuradoragendamentoespecial_id_seq' :: regclass
        ),
...
VALUES
    (
        nextval(
            'base.configuradorausencia_id_seq' :: regclass
        ),
...
INSERT INTO
    base.CONFIGURADORAUSENCIAUSUARIO (CONFIGURADORAUSENCIAID, USUARIOID)
VALUES
    (1, 1);
...
VALUES
    (
        nextval(
            'base.configuradornotificacao_id_seq' :: regclass
        ),
        NOW(),
        1,
        '01:00',
