...
INSERT INTO
    blackbelt.CONFIGURADORAGENDAMENTO (
        ID,
        AGENDADOMINGOMANHA,
        AGENDADOMINGONOITE,
        AGENDADOMINGOTARDE,
...
VALUES
    (
        nextval(
            'blackbelt.configuradoragendamento_id_seq' :: regclass
        ),
        FALSE,
        FALSE,
        FALSE,
...
INSERT INTO
    blackbelt.CONFIGURADORAGENDAMENTOESPECIAL (
        ID,
        NOME,
        PROFISSIONALID,
        DATAINICIO,
...
VALUES
    (
        nextval(
            'blackbelt.configuradoragendamentoespecial_id_seq' :: regclass
        ),
...
INSERT INTO
    blackbelt.CONFIGURADORAUSENCIA (
        ID,
        DATAACAO,
        DATAFIMAUSENCIA,
        DATAINICIOAUSENCIA,
...
VALUES
    (
        nextval(
            'blackbelt.configuradorausencia_id_seq' :: regclass
        ),
...
INSERT INTO
    blackbelt.CONFIGURADORAUSENCIAUSUARIO (CONFIGURADORAUSENCIAID, USUARIOID)
VALUES
    (1, 1);
...
INSERT INTO
    blackbelt.CONFIGURADORNOTIFICACAO (
        ID,
        DATAACAO,
        DATAINTERVALO,
        HORAMINUTOINTERVALO,
...
VALUES
    (
        nextval(
            'blackbelt.configuradornotificacao_id_seq' :: regclass
        ),
        NOW(),
        1,
        '01:00',
