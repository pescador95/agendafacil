...
public class Agendamento extends Audit {
    ...
    public Agendamento(@NotNull Agendamento entityDTO, Agendamento entityOld, TipoAgendamento tipoAgendamento,
        ...
        if (BasicFunctions.isValid(entityDTO.getComPreferencia())) {
            this.comPreferencia = entityDTO.getComPreferencia();
        }
