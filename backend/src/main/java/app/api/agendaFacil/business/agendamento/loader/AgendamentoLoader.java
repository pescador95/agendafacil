...
public class AgendamentoLoader {
    ...
    public static List<Agendamento> listByIds(List<Long> pListIdAgendamento, Boolean preferencia) {
        return AgendamentoRepository.listByIds(pListIdAgendamento, preferencia);
    }
