...
public class Contexto {
    ...
    public static Boolean scheduleEnabled() {
        return BasicFunctions.isNotEmpty(getApplicationConfig()) && getApplicationConfig().getScheduleEnabled();
    }
    ...
    public static String getAgendaFacilUrl() {
        ...
        try {
            ...
            return getApplicationConfig().getAgendaFacilUrl();
        } catch (Exception e) {
            e.getStackTrace();
    ...
    public static String getTelegramBaseUrl() {
        return getApplicationConfig().getTelegramBaseUrl();
    }

    public static String getWhatsappBaseUrl() {
        return getApplicationConfig().getWhatsappBaseUrl();
    }

    public static String getQuarkusBaseUrl() {
        return getApplicationConfig().getQuarkusBaseUrl();
    }

    public static Boolean traceMethods() {
        return BasicFunctions.isNotEmpty(getApplicationConfig()) && getApplicationConfig().getTraceMethods();
    }
}
