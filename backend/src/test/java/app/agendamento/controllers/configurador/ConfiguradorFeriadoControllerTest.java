...
@QuarkusTest
class ConfiguradorFeriadoControllerTest extends AuthContextManager {

    ConfiguradorFeriadoDTO newEntity;

    @BeforeEach
    void setUp() {
        getAuthTokens(defaultContext);
        RestAssured.basePath = "/configuradorFeriado/";
    }
    ...
    void createEntity(AuthContextTest context, ConfiguradorFeriadoDTO entity) {
        ...
        newEntity = jsonPath.getObject("data", ConfiguradorFeriadoDTO.class);

        deletedIds.add(newEntity.getId());
    }

    void updateEntity(AuthContextTest context, ConfiguradorFeriadoDTO entity) {
    ...
    void createNewEntity() {
        newEntity = new ConfiguradorFeriadoDTO();
        newEntity.setDataFeriado(LocalDate.of(Year.now().getValue(), Month.DECEMBER, 25));
        newEntity.setHoraInicioFeriado(LocalTime.of(0, 0));
        newEntity.setHoraFimFeriado(LocalTime.of(23, 59));
        newEntity.setNomeFeriado("Natal");
        newEntity.setObservacao("HO HO HO MERRY XMAS");
    }

    void updateNewEntity() {
        newEntity.setHoraFimFeriado(LocalTime.of(12, 59));
    }
}