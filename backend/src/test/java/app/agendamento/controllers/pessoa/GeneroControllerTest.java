...
@QuarkusTest
class GeneroControllerTest extends AuthContextManager {
    ...
    void createEntity(AuthContextTest context, GeneroDTO entity) {
        ...
        newEntity = jsonPath.getObject("data", GeneroDTO.class);

        deletedIds.add(newEntity.getId());
    }

    void updateEntity(AuthContextTest context, GeneroDTO entity) {
    ...
    void createNewEntity() {
        newEntity = new GeneroDTO();
        newEntity.setGenero("Optimus Prime");
    }

    void updateNewEntity() {
        newEntity.setGenero("Autobots");
    }
}