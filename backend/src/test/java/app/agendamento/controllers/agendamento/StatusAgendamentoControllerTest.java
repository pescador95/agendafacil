...
@QuarkusTest
class StatusAgendamentoControllerTest extends AuthContextManager {

    StatusAgendamentoDTO newEntity;

    @BeforeEach
    void setUp() {
        getAuthTokens(defaultContext);
        RestAssured.basePath = "/statusAgendamento/";
    }
    ...
    void createEntity(AuthContextTest context, StatusAgendamentoDTO entity) {
        ...
        newEntity = jsonPath.getObject("data", StatusAgendamentoDTO.class);

        deletedIds.add(newEntity.getId());
    }

    void updateEntity(AuthContextTest context, StatusAgendamentoDTO entity) {
    ...
    void createNewEntity() {
        newEntity = new StatusAgendamentoDTO();
        newEntity.setStatus("Desmarcado");
    }

    void updateNewEntity() {
        newEntity.setStatus("Embarcado");
    }
}