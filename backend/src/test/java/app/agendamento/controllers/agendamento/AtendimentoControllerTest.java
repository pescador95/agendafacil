...
@QuarkusTest
class AtendimentoControllerTest extends AuthContextManager {

    AtendimentoDTO newEntity;

    @BeforeEach
    void setUp() {
        getAuthTokens(defaultContext);
        RestAssured.basePath = "/atendimento/";
    }
    ...
    void createEntity(AuthContextTest context, AtendimentoDTO entity) {
        ...
        newEntity = jsonPath.getObject("data", AtendimentoDTO.class);

        deletedIds.add(newEntity.getId());
    }

    void updateEntity(AuthContextTest context, AtendimentoDTO entity) {
    ...
    void createNewEntity() {
        newEntity = new AtendimentoDTO();
        newEntity.setAtividade("surf");
        newEntity.setAvaliacao("Nota mil");
        newEntity.setEvolucaoSintomas("Virou um x men");
        newEntity.setProfissionalAtendimento(new UsuarioDTO(1L));
        newEntity.setPessoa(new PessoaDTO(7L));
    }

    void updateNewEntity() {
        newEntity.setEvolucaoSintomas("Virou um Optimus Prime");
    }
