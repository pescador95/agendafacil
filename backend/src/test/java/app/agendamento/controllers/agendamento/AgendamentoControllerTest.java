...
@QuarkusTest
class AgendamentoControllerTest extends AuthContextManager {
    ...
    void setUp() {
        ...
        RestAssured.basePath = "/agendamento/";
    }
    ...
    void updateEntity(AuthContextTest context, AgendamentoDTO entity) {
    ...
    void createNewEntity() {
        ...
        newEntity.setProfissionalAgendamento(new UsuarioDTO(1L));
    ...
    void updateNewEntity() {
        newEntity.setHorarioAgendamento(LocalTime.of(14, 00));
    }
